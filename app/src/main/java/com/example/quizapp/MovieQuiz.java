...
public class MovieQuiz extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (questionsItems.get(currentQuestions).getAnswer1().equals(questionsItems.get(currentQuestions).getCorrect())) {
                    ...
                    aans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.white));
                } else {
                    wrong++;
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            aans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.text_secondary_color));
                        }
                    }, 500);
                } else {
                    Intent intent = new Intent(MovieQuiz.this, ResultActivity.class);
                    intent.putExtra("category", "Movie"); // Replace "Art" with the corresponding category name
        ...
        bans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (questionsItems.get(currentQuestions).getAnswer2().equals(questionsItems.get(currentQuestions).getCorrect())) {
                    ...
                    bans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.white));
                } else {
                    wrong++;
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            bans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.text_secondary_color));
                        }
                    }, 500);
                } else {
                    Intent intent = new Intent(MovieQuiz.this, ResultActivity.class);
        ...
        cans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (questionsItems.get(currentQuestions).getAnswer3().equals(questionsItems.get(currentQuestions).getCorrect())) {
                    ...
                    cans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.white));
                } else {
                    wrong++;
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            cans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.text_secondary_color));
                        }
                    }, 500);
                } else {
                    Intent intent = new Intent(MovieQuiz.this, ResultActivity.class);
        ...
        dans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (questionsItems.get(currentQuestions).getAnswer4().equals(questionsItems.get(currentQuestions).getCorrect())) {
                    ...
                    dans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.white));
                } else {
                    wrong++;
                ...
                if (currentQuestions < questionsItems.size()-1) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            dans.setTextColor(ContextCompat.getColor(MovieQuiz.this, R.color.text_secondary_color));
                        }
                    }, 500);
                } else {
                    Intent intent = new Intent(MovieQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("moviequestions.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions = jsonObject.getJSONArray("moviequestions");
    ...
    public void onBackPressed() {
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(MovieQuiz.this);
